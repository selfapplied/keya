...
def test_generated_arithmetic():
    ...
    binary_pattern = Tame_operator(wild, "binary")
    
    print_matrix(uniform_field, "Initial uniform field")
    print_matrix(wild, "After Wild operator")
    print_matrix(binary_pattern, "After Tame operator (binary pattern)")
    ...
    binary_pattern2 = Tame_operator(uniform_field2, "binary")
    ...
    print("✅ generated patterns can perform arithmetic")
